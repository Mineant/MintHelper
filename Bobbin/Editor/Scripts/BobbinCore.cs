...
namespace MintHelper
{
    ...
    public class BobbinCore
    {
        ...
        void OnEditorUpdate()
        {
            if (!BobbinSettings.EnableBobbin) return;
        ...
        [MenuItem("Mineant/Bobbin/Force Refresh All Files")]
        ...
        [MenuItem("Mineant/Bobbin/Add URLs and Settings...")]
        ...
        [MenuItem("Mineant/Bobbin/Activate/Enable Bobbin")]
        public static void EnableBobbin()
        {
            if (BobbinSettings.EnableBobbin) return;

            Debug.Log("Mineant/Bobbin is being enabled.");
            BobbinSettings.EnableBobbin = true;
        }

        [MenuItem("Mineant/Bobbin/Activate/Disable Bobbin")]
        public static void DisableBobbin()
        {
            if (!BobbinSettings.EnableBobbin) return;

            Debug.Log("Bobbin is being disabled.");
            BobbinSettings.EnableBobbin = false;
        }

        [MenuItem("Mineant/Bobbin/About", priority = 0)]
        public static void About()
        {
            Debug.Log($"Bobbin is a asset not from Mineant, but from here: https://github.com/radiatoryang/bobbin.\nBobbin is a small Unity editor tool that automatically downloads files into your Unity project, usually google sheets, google docs, google drive images.\nGo to 'Mineant/Bobbin/Activate/Enable Bobbin' to start using Bobbin. This generates a BobbinSetting, which you can enter links and files to download.");
        }
